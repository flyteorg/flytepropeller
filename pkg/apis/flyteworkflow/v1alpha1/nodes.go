...
type NodeSpec struct {
	...
	ResourceOverrides *typesv1.ResourceRequirements `json:"resourceOverrides,omitempty"`
...
func (in *NodeSpec) GetResourceOverrides() *typesv1.ResourceRequirements {
	return in.ResourceOverrides
}
