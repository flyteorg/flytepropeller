...
func (in *WorkflowSpec) GetConnections() *Connections {
	...
	if len(in.Connections.UpstreamEdges) == 0 && len(in.Connections.DownstreamEdges) == 0 {
		in.Connections.UpstreamEdges = in.DeprecatedConnections.UpstreamEdges
		in.Connections.DownstreamEdges = in.DeprecatedConnections.DownstreamEdges
	}
