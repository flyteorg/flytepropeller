...
func (_m ExecutableSubWorkflow_GetOnFailurePolicy) Return(_a0 core.WorkflowMetadata_OnFailurePolicy) *ExecutableSubWorkflow_GetOnFailurePolicy {
...
func (_m *ExecutableSubWorkflow) GetOnFailurePolicy() core.WorkflowMetadata_OnFailurePolicy {
	ret := _m.Called()
