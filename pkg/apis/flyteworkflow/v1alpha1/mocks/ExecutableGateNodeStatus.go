...
type ExecutableGateNodeStatus_GetGateNodeStartedAt struct {
	*mock.Call
}

func (_m ExecutableGateNodeStatus_GetGateNodeStartedAt) Return(_a0 time.Time) *ExecutableGateNodeStatus_GetGateNodeStartedAt {
	return &ExecutableGateNodeStatus_GetGateNodeStartedAt{Call: _m.Call.Return(_a0)}
}

func (_m *ExecutableGateNodeStatus) OnGetGateNodeStartedAt() *ExecutableGateNodeStatus_GetGateNodeStartedAt {
	c_call := _m.On("GetGateNodeStartedAt")
	return &ExecutableGateNodeStatus_GetGateNodeStartedAt{Call: c_call}
}

func (_m *ExecutableGateNodeStatus) OnGetGateNodeStartedAtMatch(matchers ...interface{}) *ExecutableGateNodeStatus_GetGateNodeStartedAt {
	c_call := _m.On("GetGateNodeStartedAt", matchers...)
	return &ExecutableGateNodeStatus_GetGateNodeStartedAt{Call: c_call}
}

// GetGateNodeStartedAt provides a mock function with given fields:
func (_m *ExecutableGateNodeStatus) GetGateNodeStartedAt() time.Time {
	ret := _m.Called()
