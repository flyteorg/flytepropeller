...
func validateBranchInterface(w c.WorkflowBuilder, node c.NodeBuilder, errs errors.CompileErrors) (iface *flyte.TypedInterface, ok bool) {
	...
	for _, block := range cases {
		...
		iface2 = &flyte.TypedInterface{
			Inputs:  &flyte.VariableMap{Variables: []*flyte.VariableMapFieldEntry{}},
	...
	inputVarsFromBindings, _ := ValidateBindings(w, node, node.GetInputs(), &flyte.VariableMap{Variables: []*flyte.VariableMapFieldEntry{}},
