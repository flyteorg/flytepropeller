...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.StringSlice(fmt.Sprintf("%v%v", prefix, "include-shard-key"), []string{}, "Include the specified shard key label in the k8s FlyteWorkflow CRD label selector")
	cmdFlags.StringSlice(fmt.Sprintf("%v%v", prefix, "exclude-shard-key"), []string{}, "Include the specified shard key label in the k8s FlyteWorkflow CRD label selector")
	return cmdFlags
}
