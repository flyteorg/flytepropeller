...
func (cfg Config) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.StringSlice(fmt.Sprintf("%v%v", prefix, "include-namespace-label"), []string{}, "Include the specified namespace label in the k8s FlyteWorkflow CRD label selector")
	cmdFlags.StringSlice(fmt.Sprintf("%v%v", prefix, "exclude-namespace-label"), []string{}, "Exclude the specified namespace label from the k8s FlyteWorkflow CRD label selector")
	cmdFlags.StringSlice(fmt.Sprintf("%v%v", prefix, "include-shard-label"), []string{}, "Include the specified shard label in the k8s FlyteWorkflow CRD label selector")
	cmdFlags.StringSlice(fmt.Sprintf("%v%v", prefix, "exclude-shard-label"), []string{}, "Exclude the specified shard label from the k8s FlyteWorkflow CRD label selector")
	return cmdFlags
}
