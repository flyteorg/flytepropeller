...
type ExecutionContext_ExecutionID struct {
	*mock.Call
}

func (_m ExecutionContext_ExecutionID) Return(_a0 *core.WorkflowExecutionIdentifier) *ExecutionContext_ExecutionID {
	return &ExecutionContext_ExecutionID{Call: _m.Call.Return(_a0)}
}

func (_m *ExecutionContext) OnExecutionID() *ExecutionContext_ExecutionID {
	c := _m.On("ExecutionID")
	return &ExecutionContext_ExecutionID{Call: c}
}

func (_m *ExecutionContext) OnExecutionIDMatch(matchers ...interface{}) *ExecutionContext_ExecutionID {
	c := _m.On("ExecutionID", matchers...)
	return &ExecutionContext_ExecutionID{Call: c}
}

// ExecutionID provides a mock function with given fields:
func (_m *ExecutionContext) ExecutionID() *core.WorkflowExecutionIdentifier {
	ret := _m.Called()
...
type ExecutionContext_ID struct {
	*mock.Call
}

func (_m ExecutionContext_ID) Return(_a0 string) *ExecutionContext_ID {
	return &ExecutionContext_ID{Call: _m.Call.Return(_a0)}
}

func (_m *ExecutionContext) OnID() *ExecutionContext_ID {
	c := _m.On("ID")
	return &ExecutionContext_ID{Call: c}
}

func (_m *ExecutionContext) OnIDMatch(matchers ...interface{}) *ExecutionContext_ID {
	c := _m.On("ID", matchers...)
	return &ExecutionContext_ID{Call: c}
}

// ID provides a mock function with given fields:
func (_m *ExecutionContext) ID() string {
	ret := _m.Called()
