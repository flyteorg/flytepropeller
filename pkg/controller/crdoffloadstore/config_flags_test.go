...
func TestConfig_SetFlags(t *testing.T) {
	...
	t.Run("Test_size", func(t *testing.T) {

		t.Run("Override", func(t *testing.T) {
			testValue := "1"

			cmdFlags.Set("size", testValue)
			if vInt, err := cmdFlags.GetInt("size"); err == nil {
				testDecodeJson_Config(t, fmt.Sprintf("%v", vInt), &actual.Size)
