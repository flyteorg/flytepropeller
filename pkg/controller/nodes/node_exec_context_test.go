...
func Test_NodeContext(t *testing.T) {
	...
	nCtx := newNodeExecContext(context.TODO(), s, execContext, w1, n, nil, defaultEventVersion, nil, false, 0, nil, TaskReader{}, nil, nil, "s3://bucket", ioutils.NewConstantShardSelector([]string{"x"}))
