...
func Test_task_Handle_Barrier(t *testing.T) {
	...
	createNodeContext := func(recorder interfaces.EventRecorder, ttype string, s *taskNodeStateHolder, prevBarrierClockTick uint32) *nodeMocks.NodeExecutionContext {
		wfExecID := &core.WorkflowExecutionIdentifier{
			Project: "project",
			Domain:  "domain",
			Name:    "name",
