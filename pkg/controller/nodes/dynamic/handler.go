...
func (d dynamicNodeTaskNodeHandler) buildDynamicWorkflowTemplate(ctx context.Context, djSpec *core.DynamicJobSpec,
	...
	for _, n := range djSpec.Nodes {
		...
		// NOTE: This is the second step of 2-step-dynamic-node execution. Input dir for this step is generated by parent task
		// in the sub-directory for this subtask(n.Id) in the parent node's output dir.
