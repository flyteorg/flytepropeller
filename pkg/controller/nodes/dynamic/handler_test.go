...
func Test_dynamicNodeHandler_Handle_SubTask(t *testing.T) {
	...
	tests := []struct {
		...
		{"failed", args{s: executors.NodeStatusFailed(fmt.Errorf("error")), dj: createDynamicJobSpec()}, want{p: handler.EPhaseRetryableFailure, phase: v1alpha1.DynamicNodePhaseFailing}},
