...
import (
	...
	resourceRequest2 "github.com/lyft/flytepropeller/k8s-scheduler/pkg/client/informers/externalversions/resourceRequest"
	reflect "reflect"
	sync "sync"
	time "time"
...
type SharedInformerFactory interface {
	...
	Flyte() resourceRequest2.Interface
}

func (f *sharedInformerFactory) Flyte() resourceRequest2.Interface {
	return resourceRequest2.New(f, f.namespace, f.tweakListOptions)
}
